		...
		<FocusLock>
			<section className={style.registerSeed__wrapper}>
				...
				<form
					...
					className={style.registerSeed__form}
					action=""
				>
					<div>
						...
						<input
							...
							{...register("name", {
								...
								maxLength: {
									value: 20,
									message: "Navn kan være maks 20 tegn",
								},
							})}
						/>
					...
					<div>
						...
						<input
							...
							{...register("manufacturer", {
								required: "Produsent er påkrevd",
								maxLength: {
									value: 20,
									message: "Produsent kan være maks 20 tegn",
								},
							})}
						/>
						<div className={style.formError}>
